...
const KVKKSection: FC = () => {
  ...
  return (
    <section className="pt-[70px]">
      ...
      <div className="flex justify-center items-center paddingForSections ">
        <div className="md:border-black p-14 rounded-lg md:shadow-black shadow-lg w-[calc(200vw/3)] md:h-[700px] md:overflow-y-auto">
