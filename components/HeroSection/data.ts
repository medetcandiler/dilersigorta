export const dataSlice = [
  ...
  },
  {
    ...
    description:
      "Sağlık sigortası ile sağlığınızı ön planda tutun. Diler Sigorta, ileri tedaviler, acil durumlar ve diğer sağlık hizmetlerine geniş kapsamlı bir erişim sağlıyor.",
    bg: "/images/healt.jpg",
    href: "/urunler/saglik",
  },
];
