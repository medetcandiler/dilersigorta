...
export const products = [
  {
    ...
    content: [
      ...
      {
        id: 2,
        title: "Katılım Esaslı Temel Plan",
        description:
          "Küçük birikimlerle yarınların için güçlü bir adım atmak istiyorsan hemen Temel Plan’a başvur. Yaşam kulüpleri avantajlarından yararlanma fırsatı ile beraber faizli fon alternatiflerinin yanı sıra %30 devlet katkısı avantajıyla!",
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      {
        id: 2,
        title: "Genç Tamamlayıcı Sağlık Sigortası",
        description:
    ...
    content: [
      {
        ...
        title: "Kasko",
        description:
          "Avantajlı Kasko Sigortası ile bütçenizi zorlamadan geniş kapsamlı teminatlar ve uygun fiyatlarla aracınızı güvence altına alıyoruz.",
      },
      {
        id: 2,
  ...
  },
  {
    ...
    content: [
      {
        id: 1,
        title: "Kapsamlı İş Yeri Sigortası",
        description:
      ...
      {
        id: 2,
        title: "İş Yeri Ekstra Sigortası",
        description:
